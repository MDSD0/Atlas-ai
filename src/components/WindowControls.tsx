import { X as Cancel01Icon, Copy as Copy01Icon, Minus as MinusSignIcon, Square as SquareIcon } from "lucide-react";
      ...
      {!closeOnly && (
        <>
          <CtlButton ariaLabel="Minimize" onClick={() => void w.minimize()}>
            <MinusSignIcon size={12} strokeWidth={1.5} />
          </CtlButton>
          <CtlButton
          ...
          >
            {(() => {
              const Icon = maximized ? Copy01Icon : SquareIcon;
