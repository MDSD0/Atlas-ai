import { ChevronRight as ArrowRight01Icon, CheckCircle as CheckmarkCircle01Icon, Copy as CopyIcon, Terminal as TerminalIcon } from "lucide-react";
"use client";
...
function CopyButton({ text }: { text: string }) {
  ...
  return (
    ...
    >
      {(() => { const I = copied ? CheckmarkCircle01Icon : CopyIcon; return I ? <I size={11} strokeWidth={1.5}  /> : null; })()}
    </Button>
  );
}
