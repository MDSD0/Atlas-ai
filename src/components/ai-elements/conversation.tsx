import { ChevronDown as ArrowDown01Icon, Download as Download01Icon } from "lucide-react";
"use client";
  ...
  return (
    !isAtBottom && (
      <Button
        ...
        {...props}
      >
        <ArrowDown01Icon size={13} strokeWidth={1.5} />
      </Button>
    )
  );
};
...
export const ConversationDownload = ({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {children ?? <Download01Icon size={16} />}
    </Button>
  );
};
