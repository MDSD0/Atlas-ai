import { ChevronRight as ArrowRight01Icon, ClipboardList as CheckListIcon, Edit as Edit02Icon, Eye as EyeIcon, FileText as File01Icon, FileEdit as FileEditIcon, FilePlus as FilePlusIcon, Folder as Folder01Icon, FolderPlus as FolderAddIcon, FolderOpen as FolderOpenIcon, Search as GlobalSearchIcon, Bot as RobotIcon, Sparkles as SparklesIcon, Terminal as TerminalIcon, Wrench as ToolsIcon } from "lucide-react";
"use client";
...
const ToolImpl = ({
  ...
  return (
    ...
    >
      ...
      {hasDetails && (
        <CollapsibleContent
          className={cn("atlas-collapsible-content")}
        >
  ...
  return (
    <div className="space-y-1.5">
      ...
      <div className="flex items-stretch gap-1.5 rounded bg-muted/40 overflow-hidden">
        ...
        >
          {(() => { const I = inserted ? TerminalIcon : ArrowRight01Icon; return I ? <I size={12} strokeWidth={1.5}  /> : null; })()}
