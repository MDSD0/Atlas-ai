import { Check as Tick02Icon, ChevronRight as ArrowRight01Icon } from "lucide-react";
  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        align={align}
        className={cn("z-50 max-h-(--radix-dropdown-menu-content-available-height) w-(--radix-dropdown-menu-trigger-width) min-w-48 origin-(--radix-dropdown-menu-content-transform-origin) overflow-x-hidden overflow-y-auto rounded-3xl border border-border/60 bg-popover/85 p-1.5 text-popover-foreground shadow-xl shadow-black/20 ring-1 ring-foreground/5 backdrop-blur-2xl backdrop-saturate-150 duration-100 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=closed]:overflow-hidden dark:bg-popover/70 dark:ring-foreground/10 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95", className )}
        {...props}
      />
    </DropdownMenuPrimitive.Portal>
  )
...
function DropdownMenuSubTrigger({
  ...
  return (
    ...
    >
      {children}
      <ArrowRight01Icon strokeWidth={1.5} className="ml-auto" />
    </DropdownMenuPrimitive.SubTrigger>
  )
}
