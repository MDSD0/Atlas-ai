import { ChevronsUpDown as UnfoldMoreIcon, Check as Tick02Icon, ChevronUp as ArrowUp01Icon, ChevronDown as ArrowDown01Icon } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <UnfoldMoreIcon strokeWidth={1.5} className="pointer-events-none size-4 text-muted-foreground" />
    ...
    >
      <span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center">
        <SelectPrimitive.ItemIndicator>
          <Tick02Icon strokeWidth={1.5} className="pointer-events-none" />
        </SelectPrimitive.ItemIndicator>
      </span>
