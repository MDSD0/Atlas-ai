import { Search as SearchIcon, Check as Tick02Icon } from "lucide-react";
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-9 bg-input/50">
        ...
        />
        <InputGroupAddon>
          <SearchIcon strokeWidth={1.5} className="size-4 shrink-0 opacity-50" />
        </InputGroupAddon>
      </InputGroup>
    </div>
  )
...
function CommandItem({
  ...
  return (
    ...
    >
      {children}
      <Tick02Icon strokeWidth={1.5} className="ml-auto opacity-0 group-has-data-[slot=command-shortcut]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
    </CommandPrimitive.Item>
  )
}
