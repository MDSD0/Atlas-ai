import { Globe as GlobeIcon, Globe as Globe02Icon } from "lucide-react";
...
const REPO_URL = "https://github.com/MDSD0/Atlas-ai";
const WEBSITE = "https://atlas.app";
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center gap-4 rounded-xl border border-border/60 bg-card/60 p-5">
        <img src="/atlas-mark.png" alt="" className="size-12 object-contain" draggable={false} />
      ...
      <dl className="grid grid-cols-[110px_1fr] gap-y-2.5 text-[12px]">
        ...
        <dd>
          ...
          >
            <GlobeIcon size={12} strokeWidth={1.5} />
            MDSD0/Atlas-ai
          </button>
        </dd>
        ...
        <dd>
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-md text-[12px] underline-offset-2 hover:text-foreground hover:underline"
          >
            <Globe02Icon size={12} strokeWidth={1.5} />
            atlas.app
          </button>
        </dd>
      </dl>
