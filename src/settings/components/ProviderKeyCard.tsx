import { ArrowUpRight as ArrowUpRight01Icon, X as Cancel01Icon, CheckCircle2 as CheckmarkCircle02Icon, Edit as Edit02Icon, View as ViewIcon, EyeOff as ViewOffSlashIcon } from "lucide-react";
      ...
      {editing ? (
        <div className="flex flex-col gap-1.5">
          <div className="flex gap-1.5">
            <div className="relative flex-1">
              ...
              >
                {(() => { const I = reveal ? ViewOffSlashIcon : ViewIcon; return I ? <I size={12} strokeWidth={1.5}  /> : null; })()}
              </button>
            </div>
            <Button
              size="sm"
        ...
        <div className="flex items-center gap-1.5">
          ...
          <Button
            ...
            className="size-7"
          >
            <Edit02Icon size={12} strokeWidth={1.5} />
          </Button>
          {!onRemove ? (
            <Button
              size="icon"
