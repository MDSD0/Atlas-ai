...
export type SessionMeta = {
  ...
  createdAt: number;
  updatedAt: number;
  /** Project identity. Uses workspaceRoot for this slice. */
  projectId?: string | null;
  /** Display name for the bound project. */
  projectName?: string | null;
  /** Workspace folder bound to this session. Optional for backward compat. */
...
export function projectNameFromRoot(workspaceRoot: string | null): string {
...
export function bindSessionToWorkspace(
  session: SessionMeta,
  workspaceRoot: string | null,
): SessionMeta {
  return {
