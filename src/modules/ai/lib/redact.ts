const PATTERNS: Array<{ kind: string; re: RegExp }> = [
  ...
  { kind: "openrouter-key", re: /\bsk-or-v1-[A-Za-z0-9_-]{20,}\b/g },
  { kind: "anthropic-key", re: /\bsk-ant-[A-Za-z0-9_-]{20,}\b/g },
  { kind: "groq-key", re: /\bgsk_[A-Za-z0-9_-]{20,}\b/g },
  ...
  { kind: "gemini-api-key", re: /\bAQ\.[A-Za-z0-9_-]{20,}\b/g },
  ...
  {
    kind: "env-assign",
    re: /\b((?:(?:[A-Z][A-Z0-9_]*)?(?:API[_-]?KEY|SECRET(?:[_-]?KEY)?|ACCESS[_-]?TOKEN|AUTH[_-]?TOKEN|PASSWORD|PASSWD|PRIVATE[_-]?KEY|CLIENT[_-]?SECRET)[A-Z0-9_]*|key\d+|gq\d+|g\d+))\s*[:=]\s*(["']?)([^\s"';|&]+)\2/gi,
  },
];
