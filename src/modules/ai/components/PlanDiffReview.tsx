import { ChevronDown as ArrowDown01Icon, X as Cancel01Icon, FileEdit as FileEditIcon, FilePlus as FilePlusIcon, FolderPlus as FolderAddIcon, Check as Tick02Icon } from "lucide-react";
  ...
  return (
    <li className="group/row overflow-hidden rounded-md border border-border/50 bg-card">
      <div className="flex items-start gap-2 px-2.5 py-1.5">
        ...
        >
          <ArrowDown01Icon size={11} strokeWidth={1.5} />
        </button>
        <Icon
          size={13}
          strokeWidth={1.5}
