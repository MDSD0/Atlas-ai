  ...
  return (
    <div className="flex items-center gap-0.5">
      ...
      <IconBtn
        ...
        disabled={c.isBusy}
      >
        <Add01Icon size={13} strokeWidth={1.5} />
      </IconBtn>
      ...
      {c.voice.supported && (
        ...
        >
          {c.voice.recording ? (
            ...
            <Mic01Icon size={13} strokeWidth={1.5} />
          )}
        </IconBtn>
      )}
      ...
      <IconBtn
        ...
        disabled={miniOpen}
      >
        <Message01Icon size={13} strokeWidth={1.5} />
      </IconBtn>
      ...
      {c.isBusy ? (
        <Button
          ...
          title="Stop"
        >
          <StopCircleIcon size={13} strokeWidth={1.5} />
        </Button>
      ) : (
        <Button
          type="button"
          ...
          title="Send (Enter)"
        >
          <ArrowUpIcon size={13} strokeWidth={1.5} />
        </Button>
      )}
    </div>
  );
...
function TabButton({
  ...
  return (
    ...
    >
      {(() => { const I = icon; return I ? <I size={12} strokeWidth={1.5} /> : null; })()}
      {label}
      {count != null ? (
...
function ProviderConfigureCTA({ providerId }: { providerId: ProviderId }) {
  ...
  return (
    ...
    >
      <Settings01Icon size={13} strokeWidth={1.5} />
