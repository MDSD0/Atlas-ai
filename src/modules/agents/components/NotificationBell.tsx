import { CheckCircle2 as CheckmarkCircle02Icon, Loader2 as Loading03Icon, Bell as Notification01Icon, Bell as Notification03Icon } from "lucide-react";
      ...
      >
        ...
        {empty ? (
          <div className="border-t border-border/60 px-3 py-5 text-center text-xs leading-relaxed text-muted-foreground">
            ...
            <br />
            Run the Atlas agent or Claude Code to track it here.
          </div>
        ) : (
        ...
        <div className="border-t flex justify-center border-border/60 p-1">
          {hooksReady ? (
            ...
            >
              {(() => { const I = installing ? Loading03Icon : Notification03Icon; return I ? <I size={14} strokeWidth={1.5} className={cn(installing && "animate-spin")} /> : null; })()}
