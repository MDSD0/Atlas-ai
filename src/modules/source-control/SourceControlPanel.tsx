import { Sparkles as AiContentGenerator02Icon, AlertCircle as Alert02Icon, ChevronDown as ArrowDown01Icon, ChevronRight as ArrowRight01Icon, ChevronUp as ArrowUp01Icon, CheckCircle as CheckmarkCircle01Icon, Download as Download01Icon, Cloud as FolderCloudIcon, Folder as FolderGitTwoIcon, GitBranch as GitBranchIcon, RefreshCw as Refresh01Icon, MinusSquare as RemoveSquareIcon } from "lucide-react";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
      ...
      <aside className="flex h-full min-w-0 flex-col bg-card/80 backdrop-blur [contain:layout_style]">
        <header className="flex shrink-0 items-center justify-between gap-2 border-b border-border/50 px-3 pb-2.5 pt-3">
          <div className="flex min-w-0 items-center gap-1.5">
            <div className="inline-flex min-w-0 items-center gap-1.5 rounded-md bg-accent/40 px-2 py-1 text-[11.5px] font-medium leading-none text-foreground transition-colors hover:bg-accent">
              <FolderGitTwoIcon
                size={12}
                strokeWidth={1.9}
        ...
        {onOpenGitGraph ? (
          <button
            ...
            className="group flex shrink-0 cursor-pointer items-center gap-2 border-b border-border/40 px-3 py-2 text-left text-muted-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
          >
            <GitBranchIcon
              size={13}
              strokeWidth={1.85}
...
function DivergedBanner() {
  return (
    <div className="mx-2 mt-1 flex h-7 items-center gap-1.5 rounded-md border border-border/60 bg-accent/40 px-2 text-[10.5px] leading-none text-muted-foreground">
      <Alert02Icon
        size={11}
        strokeWidth={1.9}
        className="shrink-0"
